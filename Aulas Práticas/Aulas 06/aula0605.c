 ...
 * $Date: 2022/08/18 02:37:35 $
 * $Log: aula0605.c,v $
 * Revision 1.1  2022/08/18 02:37:35  alan.goncalves
 * Initial revision
 *
 *
 ******************************************************************************/
...
main (int argc, char **argv) 
{
	...
	double valorTermo;
	double * menorComplementar = &valorTermo;
	...
	codigoRetorno = CalcularMenorComplementar (ordemMatriz, linhaTermo, colunaTermo, matriz, menorComplementar);
	...
	/* Exibe o termo desejado do qual se calculou o menor complementar */
	printf("\nO termo escolhido da matriz eh: %.5f\n\n", termo);

	/* Exibe o menor complementar */
	printf("\nO menor complementar correspondente eh: %.5f\n\n", *menorComplementar);
