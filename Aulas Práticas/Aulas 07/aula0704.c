...
main (int argc, char *argv[]) 
{
    ...
    unsigned indice, argumentoAtual;	
	...
	{
		printf ("Uso: %s <tempo-congelamento> <numero-linhas> <numero-colunas> <percentual-defeituosos> <percentual-apagados> <linha-1> <coluna-1> <linha-2> <coluna-2>\n", argv[0]);
    ...
    linhaA = numeroArgumentoCli [5];
    colunaA = numeroArgumentoCli [6];
    linhaB = numeroArgumentoCli [7];
    colunaB = numeroArgumentoCli [8];
